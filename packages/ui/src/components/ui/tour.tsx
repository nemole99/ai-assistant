...
function createFocusGuard() {
  ...
  element.dataset.tourFocusGuard = "";
  element.tabIndex = 0;
  ...
  return (
    <StepContext.Provider value={stepContextValue}>
      <StepPrimitive
        ...
        className={cn(
          "fixed z-50 flex w-max min-w-96 flex-col gap-4 rounded-none border bg-popover p-4 text-popover-foreground shadow-md outline-none",
          className
        )}
        style={{
          ...style,
